                      ...
                      return (
                        <div key={item.id} onClick={()=>flyToCoords(item.coords)}
                          ...
                          <div className="relative h-44 w-full mb-5 rounded-[2rem] overflow-hidden shadow-inner bg-gray-200">
                            <img referrerPolicy="no-referrer" src={(item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).includes("wiki") ? "" + (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).replace("https://","") : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && String((item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).includes("wiki") ? "" + (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).replace("https://","") : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image)).includes("wiki") ? "" + String((item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).includes("wiki") ? "" + (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).replace("https://","") : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image)).replace("https://", "") + "\&w=800\&fit=cover\&cache=31536000" : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).includes("wiki") ? "" + (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).replace("https://","") : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image)} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" alt=""/>
                          </div>
                            ...
                            <div className="text-right font-sans p-1 overflow-hidden">
                              <div className="w-full h-44 md:h-52 mb-4 shadow-xl rounded-[1.5rem] overflow-hidden bg-black relative border-2 border-white">
                                {(item.video && item.id!=="1") ? (
                                  ...
                                  <img referrerPolicy="no-referrer" src={(item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).includes("wiki") ? "" + (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).replace("https://","") : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && String((item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).includes("wiki") ? "" + (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).replace("https://","") : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image)).includes("wiki") ? "" + String((item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).includes("wiki") ? "" + (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).replace("https://","") : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image)).replace("https://", "") + "\&w=800\&fit=cover\&cache=31536000" : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image) && (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).includes("wiki") ? "" + (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image).replace("https://","") : (item.image && item.image.includes('wiki') ? '' + encodeURIComponent(item.image.replace('https://', '')) : item.image)} alt="" className="w-full h-full object-cover"/>
                                )}
                              </div>
