                        ...
                        <Marker key={item.id} position={item.coords}>
                          <Popup minWidth={340} maxWidth={400} className="square-modern-popup-container">
                            <div className="text-right font-sans p-1 overflow-hidden">
                              <div <img onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src="https://loremflickr.com/800/600/nature,israel," + encodeURIComponent(item.name.he); }} src={item.image ? (item.image.includes("wiki") ? "https://images.weserv.nl/?url=" + item.image.replace("https://","") : item.image) : "https://loremflickr.com/800/600/nature"} className="w-full h-44 md:h-52 mb-4 shadow-xl rounded-[1.5rem] overflow-hidden bg-black relative border-2 border-white">
